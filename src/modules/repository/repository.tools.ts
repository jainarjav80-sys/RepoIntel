...
import { AnalyzeCommitInputSchema, AnalyzeCommitOutputSchema, RepositorySummaryInputSchema, RepositorySummaryOutputSchema, ConnectRepositoryInputSchema, ConnectRepositoryOutputSchema, CompareBranchesInputSchema, CompareBranchesOutputSchema, RepositoryHealthScoreInputSchema, RepositoryHealthScoreOutputSchema } from './schemas/commit.schema.js';
...
export class RepositoryTools {
  ...
  async analyzeCommit(input: any, ctx: ExecutionContext) {
    try {
  ...
  async repositorySummary(input: any, ctx: ExecutionContext) {
    try {
